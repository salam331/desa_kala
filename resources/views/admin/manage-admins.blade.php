        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-10">
            <div class="flex justify-between items-center mb-6">
                <h2 class="font-bold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Manajemen Admin') }} ({{ $totalAdmins }})
                </h2>
            </div>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ substr($admin->name, 0, 1) }}</span>
                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <div
                                                ...
                                                <span
                                                    class="text-lg font-medium text-gray-700 dark:text-gray-300">{{ substr($admin->name, 0, 1) }}</span>
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $admin->name }}
                                            </div>
                                            <div class="text-sm text-gray-500 dark:text-gray-300">{{ $admin->email }}</div>
                                            <div class="text-xs text-gray-400 dark:text-gray-500">Bergabung:
                                                {{ $admin->created_at->format('d/m/Y') }}</div>
                                        </div>
                                    </div>
            ...
            <div class="mt-3">
                ...
                <form method="POST" action="{{ route('admin.manage-admins.create') }}">
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button"
                            onclick="document.getElementById('create-admin-modal').classList.add('hidden')"
