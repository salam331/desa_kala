                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="kategori" id="kategori"
                                    ...
                                    <option value="kegiatan" {{ old('kategori') == 'kegiatan' ? 'selected' : '' }}>Kegiatan Desa</option>
                                    <option value="pembangunan" {{ old('kategori') == 'pembangunan' ? 'selected' : '' }}>Pembangunan Infrastruktur</option>
                                    <option value="event" {{ old('kategori') == 'event' ? 'selected' : '' }}>Event dan Festival</option>
                                    <option value="panorama" {{ old('kategori') == 'panorama' ? 'selected' : '' }}>Panorama Desa</option>
                                </select>
                                @error('kategori')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
