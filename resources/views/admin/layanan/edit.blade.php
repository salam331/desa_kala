            ...
            <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="kategori" name="kategori"
                            ...
                            <option value="administrasi" {{ old('kategori', $layanan->kategori) === 'administrasi' ? 'selected' : '' }}>Administrasi</option>
                            <option value="perizinan" {{ old('kategori', $layanan->kategori) === 'perizinan' ? 'selected' : '' }}>Perizinan</option>
                        </select>
                        @error('kategori')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="waktu_proses" name="waktu_proses" value="{{ old('waktu_proses', $layanan->waktu_proses) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="biaya" name="biaya" value="{{ old('biaya', $layanan->biaya) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="kontak" name="kontak" value="{{ old('kontak', $layanan->kontak) }}"
                    ...
                    <div>
                        ...
                        @if($layanan->gambar)
                            <div class="mb-2">
                                <img src="{{ asset($layanan->gambar) }}" alt="Current Image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $layanan->is_active) ? 'checked' : '' }}
                ...
                <div class="mt-6">
                    ...
                    <div id="prosedur-container">
                        @php $prosedurData = old('prosedur', $layanan->prosedur ?? []); @endphp
                        @if(is_array($prosedurData) && count($prosedurData) > 0)
                ...
                <div class="mt-6">
                    ...
                    <div id="syarat-container">
                        @php $syaratData = old('syarat', $layanan->syarat ?? []); @endphp
                        @if(is_array($syaratData) && count($syaratData) > 0)
                            @foreach($syaratData as $index => $syarat)
